...
public class TP_016{
  ...
  public void valid_login() 
	...
	public void Service_match()
	{
		...
		driver.findElement(By.xpath("//li[contains(text(),'Beauty & Fashion')]")).click();
		driver.findElement(By.xpath("//div[4]//button[1]")).click();
		List<WebElement> add=driver.findElements(By.xpath("//div[@class='alert alert-danger text-center']"));
		actual=add.get(0).getText();
		expected="THIS CATEGORY HAS ALREADY EXIST IN LIST";
		Assert.assertEquals(expected, actual);
	}
