...
public class TP_007{
  ...
  public void valid_login() 
	...
	public void Creating_Service()
	{
		...
		List<WebElement> create=driver.findElements(By.xpath("//div[contains(text(),'Service has been added')]"));
		actual=create.get(0).getText();
		expected="Service has been added";
		Assert.assertEquals(expected, actual);
	}
	@Test(priority=2)
	public void Updating_Service()
	{
		driver.findElement(By.xpath("//input[@id='exampleInputAmount']")).sendKeys("Helicopter");
		...
		driver.findElement(By.xpath("//ul[@class='line-btn pull-right']//button[@class='btn btn-success w-btn-success']")).click();
		List<WebElement> update=driver.findElements(By.xpath("//div[contains(text(),'Service has been updated')]"));
		actual=update.get(0).getText();
		expected="Service has been updated";
		Assert.assertEquals(expected, actual);
	}
	@Test(priority=3)
	...
	{	
			...
			driver.findElement(By.linkText("Profile")).click();
		 	driver.findElement(By.xpath("//tr[1]//td[4]//ul[1]//li[2]//a[1]")).click();
			driver.findElement(By.xpath("//a[@id='btn_deleteService']")).click();
			List<WebElement> delete=driver.findElements(By.xpath("//div[contains(text(),'Service has been deleted')]"));
			actual=delete.get(0).getText();
			expected="Service has been deleted";
			Assert.assertEquals(expected, actual);
